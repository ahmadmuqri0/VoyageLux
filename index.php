    ...
    <div class="row"> 
                ...
                <div class="row h-100 align-items-center">
                    <div class="col-lg-12">
                        <div class="text-white">
                            ...
                            <form method="post" action="homestaygrid.php">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-lg-2">
                                        <div class="form-group">
                                            <button type="submit" name="filter" class="btn btn-success w-100">Search Homestay</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
        ...
        <div class="full-row">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h2 class="text-secondary double-down-line text-center mb-4">Recent Homestay</h2>
                    </div>
                    <!--- <div class="col-md-6">
                        ...
                        <div class="tab-content mt-4" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home">
                                <div class="row">
									...
									<?php $query=mysqli_query($con,"SELECT homestay.*, user.uname,user.uimage FROM `homestay`,`user` WHERE homestay.uid=user.uid ORDER BY date DESC LIMIT 9");
                                    ...
                                    <div class="col-md-6 col-lg-4"><!-- FOR MORE PROJECTS visit: codeastro.com -->
                                        <div class="featured-thumb hover-zoomer mb-4">
                                            ...
                                            <div class="featured-thumb-data shadow-one">
                                                <div class="p-3">
                                                    <h5 class="text-secondary hover-text-success mb-2 text-capitalize"><a href="homestaydetail.php?pid=<?php echo $row['0'];?>"><?php echo $row['1'];?></a></h5>
                                                ...
                                                <div class="bg-gray quantity px-4 pt-4">
                                                    <ul>
                                                        ...
                                                        <li><span><?php echo $row['8'];?></span> Kitchen</li>
                                                        <li><span><?php echo $row['7'];?></span> Balcony</li>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-3 pb-1">
                            <div class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9"> <img src="images/thumbnail4/1.jpg" alt="">
                                <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
									<?php
										$query=mysqli_query($con,"SELECT count(state), homestay.* FROM homestay where city='Puchong'");
											while($row=mysqli_fetch_array($query))
											{
										?>
                                    <h4 class="hover-text-success text-capitalize"><a href="statehomestay.php?id=<?php echo $row['16']?>"><?php echo $row['state'];?></a></h4>
                                    <span><?php $total = $row[0]; echo $total;?> Homestays Listed</span>
                                </div>
									<?php } ?>
                            </div>
                        </div><!-- FOR MORE PROJECTS visit: codeastro.com -->
                        ...
                        <div class="col-md-6 col-lg-3 pb-1"><!-- FOR MORE PROJECTS visit: codeastro.com -->
                            <div class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9"> <img src="images/thumbnail4/3.jpg" alt="">
                                <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
                                    <?php
										$query=mysqli_query($con,"SELECT count(state), homestay.* FROM homestay where city='Kuantan'");
											while($row=mysqli_fetch_array($query))
												{
										?>
                                    <h4 class="hover-text-success text-capitalize"><a href="statehomestay.php?id=<?php echo $row['16']?>"><?php echo $row['state'];?></a></h4>
                        ...
                        <div class="col-md-6 col-lg-3 pb-1">
                            <div class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9"> <img src="images/thumbnail4/4.jpg" alt="">
                                <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
                                    <?php
										$query=mysqli_query($con,"SELECT count(state), homestay.* FROM homestay where city='Kota Bharu'");
											while($row=mysqli_fetch_array($query))
												{
										?>
                                    <h4 class="hover-text-success text-capitalize"><a href="statehomestay.php?id=<?php echo $row['16']?>"><?php echo $row['state'];?></a></h4>
