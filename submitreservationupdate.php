...
if(isset($_POST['add']))
{
	...
	$sql="UPDATE reservation SET pax='{$pax}',checkin='{$checkin}',checkout='{$checkout}' WHERE sid='{$sid}'";
	$result=mysqli_query($con,$sql);
	if($result == true)
	{
		$msg="<p class='alert alert-success'>Reservation Updated</p>";
		header("Location:reservationfeature.php?msg=$msg");
	}
	else{
		$msg="<p class='alert alert-warning'>Reservation Not Updated</p>";
		header("Location:reservationfeature.php?msg=$msg");
	}
}							
?>
                ...
                <div class="row p-5 bg-white mx-5">
                    <form method="post" enctype="multipart/form-data" class="mx-auto" style="max-width: 50rem;">
                        <div class="description">
                            <h5 class="text-secondary"><?php echo $row['6'];?> </h5><hr>
                            <?php echo $error; ?>
                            <?php echo $msg; ?>
                            <div class="row" style="margin-left: 3rem;">
                                <div class="row">
                                    <div class="col-xl-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9">
                                                <input type="number" value="<?php echo $row['1']?>" class="form-control" name="pax" required placeholder="Enter Number">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text" value="<?php echo $row['2']?>" class="form-control" name="checkIn" required placeholder="check in: dd-mm-yyyy">
                                            <br>
                                            <input type="text" value="<?php echo $row['3']?>" class="form-control" name="checkOut" required placeholder="check out: dd-mm-yyyy">
                                        </div>	
                                    </div>
                                </div>
                            </div>
