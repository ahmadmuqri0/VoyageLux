    ...
    <div class="row"> 
        ...
        <div class="banner-full-row page-banner" style="background-image:url('images/breadcromb.jpg');">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <h2 class="page-name float-left text-white text-uppercase mt-1 mb-0"><b>User Listed Homestay</b></h2>
                    </div>
                    <div class="col-md-6">
                        <nav aria-label="breadcrumb" class="float-left float-md-right">
                            <ol class="breadcrumb bg-transparent m-0 p-0">
                                <li class="breadcrumb-item text-white"><a href="#">Home</a></li>
                                <li class="breadcrumb-item active">User Listed Homestay</li>
                            </ol>
                        </nav>
                    </div>
                </div>
        ...
        <div class="full-row bg-gray">
            <div class="container"><!-- FOR MORE PROJECTS visit: codeastro.com -->
                    <div class="row mb-5">
						<div class="col-lg-12">
							<h2 class="text-secondary double-down-line text-center">User Listed Homestay</h2>
							<?php 
								if(isset($_GET['msg']))	
								echo $_GET['msg'];	
							?>
					...
					<table class="items-list col-lg-12 table-hover" style="border-collapse:inherit;">
						...
						<!-- FOR MORE PROJECTS visit: codeastro.com -->
							<?php 
							$uid=$_SESSION['uid'];
							$query=mysqli_query($con,"SELECT * FROM `homestay` WHERE uid='$uid'");
                            ...
                            <tr>
                                <td>
                                    ...
                                    <div class="property-info d-table">
                                        <h5 class="text-secondary text-capitalize"><a href="homestaydetail.php?pid=<?php echo $row['0'];?>"><?php echo $row['1'];?></a></h5>
                                        <span class="font-14 text-capitalize"><i class="fas fa-map-marker-alt text-success font-13"></i>&nbsp; <?php echo $row['13'];?></span>
                                        <div class="price mt-3">
											<span class="text-success">RM &nbsp;<?php echo $row['12'];?></span>
										</div>
                                    </div>
								</td>
