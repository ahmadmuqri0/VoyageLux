...
if(isset($_POST['add']))
{
	...
	$sql = "UPDATE homestay SET title= '{$title}', pcontent= '{$content}', type='{$ptype}', bhk='{$bhk}',
	...
	if($result == true)
	{
		$msg="<p class='alert alert-success'>Homestay Updated</p>";
		header("Location:homestayfeature.php?msg=$msg");
	}
	else{
		$msg="<p class='alert alert-warning'>Homestay Not Updated</p>";
		header("Location:homestayfeature.php?msg=$msg");
	}
}						
?>
    ...
    <div class="row"> 
        ...
        <div class="full-row">
            <div class="container">
                    <div class="row">
						<div class="col-lg-12">
							<h2 class="text-secondary double-down-line text-center">Update Homestay</h2>
                        </div>
					</div>
                    <div class="row p-5 bg-white">
                        <form method="post" enctype="multipart/form-data">
								...
								<?php
									...
									$pid=$_REQUEST['id'];
									$query=mysqli_query($con,"select * from homestay where pid='$pid'");
										...
										<div class="row">
											...
											<div class="col-xl-6">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input type="text" class="form-control" name="kitc" required value="<?php echo $row['8']; ?>">
													</div>
												</div>
											...
											<div class="col-xl-6">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														...
														<img src="homestay/<?php echo $row['17'];?>" alt="pimage" height="150" width="180">
													</div>
												</div>
												<div class="form-group row">
