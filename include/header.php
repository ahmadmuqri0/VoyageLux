<header id="header" class="transparent-header-modern fixed-header-bg-white w-100">
            ...
            <div class="main-nav secondary-nav hover-success-nav py-2">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <nav class="navbar navbar-expand-lg navbar-light p-0"> <a class="navbar-brand position-relative" href="index.php"><img width="100" height="100" class="nav-logo" src="images/logo/logoVL.png" alt=""></a>
                                    ...
                                    <ul class="navbar-nav mr-auto">
										...
										<li class="nav-item dropdown">
											...
											<ul class="dropdown-menu">
												...
												<li class="nav-item"> <a class="nav-link" href="homestayfeature.php">Your Homestay</a> </li>
												<li class="nav-item"> <a class="nav-link" href="reservationfeature.php">Your Reservation</a> </li>
